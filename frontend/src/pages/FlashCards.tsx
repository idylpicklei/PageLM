...
export default function FlashCards() {
  ...
  const load = async () => {
    ...
    try {
      ...
      const [{ flashcards }, fileRes, skillList] = await Promise.all([
      ...
      setSkills((skillList || []).sort((a, b) => b.created - a.created));
        ...
        <section className="mb-10">
          ...
          <div className="rounded-2xl bg-stone-950 border border-zinc-800 p-4 mb-4">
            ...
            <div className="grid gap-3">
              ...
              <input
                ...
                placeholder="Skill name (e.g. Make flashcards)"
          ...
          {skills.length ? (
            ...
            <div className="rounded-2xl border border-dashed border-zinc-800 px-4 py-8 text-center text-stone-400 text-sm">
              ...
              No skills yet. Add one above or reload to get starter prompts.
